...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('/test-case/duplicate', [TestCaseController::class, 'duplicate'])->name("test_case_duplicate");
    Route::post('/test-case/{id}/restore', [TestCaseController::class, 'restore'])->name("test_case_restore");
    Route::delete('/test-case/{id}', [TestCaseController::class, 'forceDelete'])->name("test_case_force_delete");
